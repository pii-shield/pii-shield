...
A bad pattern can never terminate your Node process. An invalid
`customRegexes` or `safeRegexes` entry is **skipped and the rest of the list is
...
stray bracket switched off every rule in it.) An invalid `sensitiveKeyPatterns`
